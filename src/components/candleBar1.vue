<template>
  <div class="first-container">
    <div class="row">
      ...
      <div class="col-md-6">
        <button class="btn btn-primary float-right" @click="clearData">Clear</button>
        <button
        class="btn btn-primary float-right mr-3"
        @click="openInput()"
        >Unggah Dokumen</button>
        <input ref="docs" type="file" accept=".csv" v-on:change="csvJSON($event)" style="display: none;">
      </div>
    </div>
    <div id="chart">
      <div>
      ...
      <ApexCharts ref="realtimeChart" height="350" :series="series" :options="chartOptions" type="candlestick"></ApexCharts>
    </div>
  </div>
</template>
